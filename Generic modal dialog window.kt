// The InfoMsg object eliminates repetitive boilerplate code for creating AlertDialogs throughout the app.
// Instead of writing 5-10 lines of AlertDialog.Builder code every time you need a dialog, developers call one simple function.

// How it accelerates development:
// * Reduces dialog creation from ~8 lines to 1 function call
// * Provides consistent dialog appearance and behavior across the app
// * Handles common patterns: simple info messages and Yes/No confirmations with callbacks
// * Supports default button texts with easy customization
// * Centralizes dialog logic - if you need to change dialog styling globally, modify one place instead of dozens of scattered AlertDialog calls throughout the codebase
